...
# Adjust the department of "Organic Riced Cauliflower" to 'frozen' and 'Roasted Almond Butter' to 'pantry' since they fall within the top 1000
...
sample_fraction = 0.1  # Adjust this based on how much of the data to sample
...
# Replace the number with the product_id
top_5_substitutes = find_top_n_substitutes_with_names(11109, n=5)
print(top_5_substitutes)

# -----------------------
# Pre-Calculation Setup with Substitutes using Item-Itenm 
# -----------------------
